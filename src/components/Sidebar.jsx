...
const Sidebar = ({ setSelectedGroup }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Flex align="center">
          <Icon as={FiUsers} fontSize="24px" color="cyan.300" mr={2} />
        ...
        <VStack spacing={3} align="stretch">
          {groups.map((group) => (
            <Box
              ...
              borderWidth="1px"
              borderColor={
                userGroups.includes(group?._id) ? "cyan.300" : "whiteAlpha.200"
              }
              transition="all 0.2s"
              _hover={{
            ...
            >
              <Flex justify="space-between" align="center">
                ...
                <Button
                  size="sm"
                  colorScheme={
                    userGroups?.includes(group?._id) ? "red" : "cyan"
                  }
                  ...
                  _hover={{
                    ...
                    bg: group.isJoined ? "red.500" : "cyan.500",
                  }}
                  transition="all 0.2s"
                >
                  {userGroups.includes(group?._id) ? (
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent bg="#111b35" color="white" border="1px solid" borderColor="whiteAlpha.300">
